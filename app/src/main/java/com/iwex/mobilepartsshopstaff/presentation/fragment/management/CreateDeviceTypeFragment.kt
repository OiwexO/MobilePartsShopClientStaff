 ...
 * Use the [CreateDeviceTypeFragment.newInstance] factory method to
...
class CreateDeviceTypeFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment CreateDeviceTypeFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            CreateDeviceTypeFragment().apply {
